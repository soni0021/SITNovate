...
import authMiddleware from './middleware.js'; // [./authMiddleware.js](src/backend/authMiddleware.js)
import { connectDB } from './db.js'; // [./config/db.js](src/backend/config/db.js)
